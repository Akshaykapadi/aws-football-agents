...
get_runtime_name() {
  case "$1" in
    ai-gk)   echo "ai_gk_memory_agent_ak" ;;
    ai-def)  echo "ai_def_memory_agent_ak" ;;
    ai-mid)  echo "ai_mid_memory_agent_ak" ;;
    ai-fwd1) echo "ai_fwd1_memory_agent_ak" ;;
    ai-fwd2) echo "ai_fwd2_memory_agent_ak" ;;
    *) echo "" ;;
  esac
}
