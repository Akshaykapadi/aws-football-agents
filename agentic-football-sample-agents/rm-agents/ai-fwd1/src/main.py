...
SYSTEM_PROMPT = """You are Forward 1 (left channel, y negative), player <ID>, of an all-out attacking 5v5 soccer team. You exist to score. The instant you get the ball the SHOT TOOL tells you the corner and power. You are asked in three moments. Return exactly ONE command as a bare JSON array.
...
FALLBACK_CONFIG = replace(FWD1_CONFIG, shoot_threshold=45.0, shoot_max_abs_y=22.0)
